...
def grand_avg(jdbeg,jdend,outfile,comb,attr_in,nifiles,infile_h,infile_t,*,lyyyyjjj=True,tzone=None,l2uam=False,tmpoutf=None):
    # Include functions
    ...
    print ("  3. PROCESSING GRAND AVERAGE")
...
def main():
    ...
    if not os.path.exists(infile0):
      ...
      print ('Program exits from grand_avg')
      exit()
    try:
      fin0 = uamiv(infile0)
    except:
    ...
    # Do the main process
    grand_avg(jdbeg,jdend,outfile,comb,attr_in,nifiles,infile_h,infile_t,lyyyyjjj=lyyyyjjj,tzone=tz,l2uam=l2uam,tmpoutf=tmpoutf)
