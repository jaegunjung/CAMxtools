...
... module:: psd_pm25_2nddavg_annavg
...
__all__=['psd_pm25_2nddavg_annavg',]
import sys
...
def psd_pm25_2nddavg_annavg(jdbeg,jdend,out_anndavg,out_2nddavg,csv_anndavg,csv_2nddavg,comb,attr_in,nifiles,infile_h,infile_t,*,lyyyyjjj=True,tzone=None,l2uam=False,tmpoutf=None):
    # Include functions
...
def main():
    ...
    if not os.path.exists(infile0):
      ...
      print ('Program exits from psd_pm25_2nddavg_annavg')
      exit()
    try:
      fin0 = uamiv(infile0)
    except:
    ...
    # Do the main process
    psd_pm25_2nddavg_annavg(jdbeg,jdend,out_anndavg,out_2nddavg,csv_anndavg,csv_2nddavg,comb,attr_in,nifiles,infile_h,infile_t,lyyyyjjj=lyyyyjjj,tzone=tz,l2uam=l2uam,tmpoutf=tmpoutf)
